Feature: Purchase prepaid
  ...
  Scenario: Purchase Vodacom data bundle
    ...
    And the Vodacom tile should be visible
    When I click on the Vodacom tile
    ...
    And I should see "Vodacom" selected from the "Provider" input
    ...
    When I choose "Data bundles" for "Voucher type"
    Then I should see "30MB Data Bundle @ R12" selected for the Data bundle Amount
    When I select "100MB Data Bundle @ R29" for Data bundle Amount
    And I complete "Cell phone number" with "0829850572"
    ...
    And I should see the following data bundle recharge confirmation details:
      | From account      | ACCESSACC - 10-00-035-814-0 |
      | Available balance | R 8 756.41                  |
      | Provider          | Vodacom                     |
      | Voucher type      | Data bundles                |
      | Recharge amount   | 100MB Data Bundle @ R29     |
      | Cell phone number | 0829850572                  |
    ...
    Then I should see the following data bundle recharge details:
      | From account      | ACCESSACC - 10-00-035-814-0 |
      | Available balance | R 8 756.41                  |
      | Provider          | Vodacom                     |
      | Voucher type      | Data bundles                |
