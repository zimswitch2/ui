Feature: Once off payment
  ...
  Scenario: A customer pays a private beneficiary and requests a corresponding fax notification to be sent
    ...
    And I choose "Fax" for "Payment notification method"
    Then I should see payment notification cost to be "(Fax fee: R 3.20)"
    When I complete "Recipient fax number" with "0123456789"
    ...
    And I should see the following payment confirmation details:
      ...
      | Ben will receive payment notifications by fax on | 0123456789                  |
