describe('Beneficiaries', function () {
    ...
    describe('when ViewBeneficiaryGroupsController', function () {
        var scope, mock, service, sorter, groupResponse, location, beneficiaries, expectedFormattedBeneficiaries,
            beneficiariesService, beneficiariesFlowService, applicationParametersService, cardService, groups, cached;
        ...
        beforeEach(inject(function ($rootScope, $controller, _mock_, $sorter) {
            ...
            beneficiariesFlowService = jasmine.createSpyObj('beneficiariesFlowService', ['setBeneficiaryFlowParameter', 'getBeneficiaryFlowParameter']);
            ...
            cardService.current.and.returnValue({
                "countryCode": "ZA",
                "number": 12345,
            ...
            $controller('ViewBeneficiaryGroupsController', {
                ...
                BeneficiariesFlowParameters: beneficiariesFlowService,
