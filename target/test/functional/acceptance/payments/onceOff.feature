Feature: Once off payment
  ...
  Scenario: A customer pays a private beneficiary
    ...
    And I should see "" in the "Recipient name" input
    And I should see "" in the "Recipient email address" input
    ...
    Then I should not see "Payment notification method"
    And I should not see "Email"
    And I should not see "SMS"
    And I should not see "Fax"
    And I should not see "Recipient name"
    And I should not see "Recipient email address"
