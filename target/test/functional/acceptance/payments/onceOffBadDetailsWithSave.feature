Feature: Once off payment
  ...
  Scenario:
  Should fail to save beneficiary when a customer attempts to perform a once off payment with bad
  beneficiary details
    ...
    Then I should see error notification with "There was a problem with the beneficiary details entered. The beneficiary was not saved and payment was unsuccessful"
