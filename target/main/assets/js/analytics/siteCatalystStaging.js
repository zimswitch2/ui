...
var s_account='accstandardbankibrefresh-staging';

var s=s_gi(s_account);

var Country = "South Africa";
var BusinessUnit = "IB Refresh";
var ProductCategory = "Internet Banking Refresh";
...
s.linkInternalFilters="javascript:,localhost,standardbank.co.za";
...
/* Add calls to plugins here */
	...
	s.prop32 = s.eVar37 = Country;
	s.prop33 = s.eVar38 = BusinessUnit;
	s.prop34 = s.eVar39 = ProductCategory;
	...
	var ppvArray_len = typeof ppvArray === ' object' ? ppvArray.length : 0;
	s.prop29 = ppvArray_len>1 ? ppvArray[0]:'';
	s.prop16 = ppvArray_len>2 ? ppvArray[1]:'';
	s.prop30 = ppvArray_len>3 ? ppvArray[2]:'';
	s.prop31 = ppvArray_len>4 ? ppvArray[3]:'';
	...
	//Time Parting
	s.prop18=s.eVar18=s.getTimeParting('','+2','','0');

	//New vs. Repeat Visitor
	s.prop25=s.eVar19=s.getNewRepeat();

	//External Campaign Tracking
	s.campaign=s.getValOnce(s.getQueryParam('cid,s_kwcid'),'s_campaign',0);
	...
	// Capture the visitorID
	s.eVar36=s.prop36="D=s_vi";
	...
	s.eVar28=s.getTimeToComplete(s.eVar28,'ttc',0);
}
...
s.setTagContainer("IBRefreshDev_s");
