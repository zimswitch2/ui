Feature: Once off payment
  ...
  Scenario: Should still save listed beneficiary even when payment fails due to a server side error
    ...
    Then I should see the "Once-off Payment" page
    And I should see success notification with "Beneficiary has been successfully added"
    And I should see error notification with "Could not process payment: We are experiencing technical problems. Please try again later"